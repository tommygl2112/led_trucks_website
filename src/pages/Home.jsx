    ...
    <>
      ...
      <div className="section-2">
        <div className="section-2__container">
          <h1 className="section-2__container__title-1">
            Our trucks in action
          </h1>
          <h2 className="section-2__container__title-2">
            Mobile billboards are viewed by 95% of people that pass by them and
            are read by 85% of people. Almost TWICE the attention that static
            billboards receive!
          </h2>
          <ArrowButton
            text={"Send"}
            link={"/#1"}
            styles={{ alignment: "left", color: "#0061FE", fontSize: "20px" }}
          />
      ...
      <div className="section-4">
        <div className="section-4__container">
          <div>
            <img
              src="/assets/mapa2.png"
              className="section-4__container__map2"
              alt=""
            />
          </div>
          <div>
            ...
            <p className="section-4__container__subtitle">
              {" "}
              “Individual vehicle advertising generates between 30,000 to 70,000
              daily vehicle impressions”
            </p>
      ...
      <div className="section-7">
        <h1 className="section-7__title">Preview your AD on our truck</h1>
        <p className="section-7__subtitle">
          {" "}
          You can change the truck and turn it arround
        </p>

      ...
      <div className="slider-container__container">
        <div className="slider-container__container__overlayed-content">
          <h1 className="slider-container__container__overlayed-content__title1">
            <span className="slider-container__container__overlayed-content__title1--blue">
              Shine a light on your brand!
            </span>
          </h1>

          <p className="slider-container__container__overlayed-content__content">
            Shine a light on your brand with LED Truck. Our unique LED
            advertising trucks are designed to showcase your message, ensuring
            maximum.
          </p>
        ...
        >
          <SwiperSlide>
            <img
              className="slider-container__container__slider-content__truck-slide"
              src={"/assets/truckmain5.png"}
              alt="logo"
            />
          </SwiperSlide>
        </Swiper>
